...
#include <Core/SceneObject/SceneOld.h>
...
namespace Agmd
{
    ...
    void SceneOld::Render(TRenderPass pass) const
    {
    ...
    void SceneOld::Update(a_uint64 t_diff)
    {}

    void SceneOld::AddMesh(Displayable* m)
    {
        m_vMesh.push_back(m);
    }


    void SceneOld::AddLight(Light* l)
    {
        m_lights.push_back(l);
    }

    void SceneOld::SetSkyBox(SkyBox* _Sky)
    {
        m_SkyBox = _Sky;
    }

    SkyBox* SceneOld::GetSkyBox()
    {
        return m_SkyBox;
    }

    void SceneOld::RemoveMesh(Displayable* m)
    {
    ...
    */
    ...
    const std::vector<Light*>& SceneOld::GetLights()
    {
        return m_lights;
    }
}
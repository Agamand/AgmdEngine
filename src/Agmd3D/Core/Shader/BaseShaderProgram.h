...
namespace Agmd
{
    ...
    public :
		...
		virtual void SetParameter(std::string name,	float* value, uint32 count) = 0;
		virtual void SetParameter(std::string name,	vec2* value, uint32 count) = 0;
		virtual void SetParameter(std::string name,	vec3* value, uint32 count) = 0;

...
{
    template <class T, template<class> class A = DefaultAllocator>
    class List
    {
    public:
        class ListNode;
        ...
        public:
            ...
            ConstIterator operator ++(a_int32)
            {
    ...
    template <class T, template <class> A>
    inline const List<T, A>::ListNode& List<T, A>::Begin()
    {
        return *m_begin;
    }

    template <class T, template <class> A>
    inline const List<T, A>::ListNode& List<T, A>::End()
    {
        return *m_last;
    }

    template <class T, template <class> A>
    inline void List<T, A>::push_front(T element)
    {
    ...
    template <class T, template <class> A>
    inline void List<T, A>::push_back(T element)
    {
    ...
    template <class T, template <class> A>
    inline void List<T, A>::pop(T element)
    {
        ListNodePtr node = m_begin;
        while (node)
        {
    ...
    template <class T, template <class> A>
    inline void List<T, A>::pop(Iterator& itr)
    {
        if (!itr.current)
            return;
    ...
    template <class T, template <class> A>
    inline void List<T, A>::pop(ConstIterator& itr)
    {
    }

    template <class T, template <class> A>
    inline void List<T, A>::pop_front()
    {
    }

    template <class T, template <class> A>
    inline void List<T, A>::pop_back()
    {
    }


    template <class T, template <class> A>
    inline a_uint32 List<T, A>::size() const
    {
        return m_size;
    }

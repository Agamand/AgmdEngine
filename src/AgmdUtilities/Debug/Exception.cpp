...
namespace AgmdUtilities
{
	...
	LoadingFailed::LoadingFailed(const std::string& File, const std::string& Message) : Exception(StringBuilder("Erreur dans le chargement de ")(File)("\n")(Message))
	{}

	OutOfMemory::OutOfMemory(const std::string& msg) : Exception(msg)
	{}

	Unsupported::Unsupported(const std::string& function) : Exception(StringBuilder("Fonctionnalité non supportée")("\n")(function))
	{}

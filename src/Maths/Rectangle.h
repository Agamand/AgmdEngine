...
namespace Agmd
{
    ...
    AGMD_EXPORT std::istream& operator >>(std::ostream& stream, Rectangle& rect);
    AGMD_EXPORT std::ostream& operator <<(std::ostream& stream, const Rectangle& rect);
